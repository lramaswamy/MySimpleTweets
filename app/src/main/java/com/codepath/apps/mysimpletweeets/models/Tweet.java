...
//Parse the Json, store the data and store the logic to display tweets
    @Parcel
public class Tweet {
    // List out the attributes that I care about

    private String body;
    private long uid;//unique tweet database id
    ...
    //Pass in array of JSON Objects and output of list of tweets
